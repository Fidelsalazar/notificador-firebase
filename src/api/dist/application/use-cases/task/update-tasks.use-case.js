...
const firebase_task_service_1 = require("../../../infrastructure/services/firebase-task.service");
let UpdateTaskUseCase = class UpdateTaskUseCase {
    constructor(firebaseTaskService) {
        this.firebaseTaskService = firebaseTaskService;
    }
    async execute(userId, taskId, updatedTask) {
...
exports.UpdateTaskUseCase = UpdateTaskUseCase = __decorate([
    ...
    __metadata("design:paramtypes", [firebase_task_service_1.FirebaseTaskService])
], UpdateTaskUseCase);
//# sourceMappingURL=update-tasks.use-case.js.map